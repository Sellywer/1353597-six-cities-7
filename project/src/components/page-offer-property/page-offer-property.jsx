              ...
              <div className="property__host">
                ...
                <div className="property__host-user user">
                  <div className="property__avatar-wrapper property__avatar-wrapper--pro user__avatar-wrapper">
                    <img className="property__avatar user__avatar" src="img/avatar-angelina.jpg" style = {{width: '74', height: '74'}} alt="Host avatar" />
                  </div>
            ...
            <div className="near-places__list places__list">
              <article className="near-places__card place-card">
                <div className="near-places__image-wrapper place-card__image-wrapper">
                  <a href="#/">
                    <img className="place-card__image" src="img/room.jpg" style = {{width:'260', height:'200'}} alt="Place" />
                  </a>
                </div>
              ...
              <article className="near-places__card place-card">
                <div className="near-places__image-wrapper place-card__image-wrapper">
                  <a href="#/">
                    <img className="place-card__image" src="img/apartment-02.jpg" style = {{width:'260', height:'200'}} alt="Place" />
                  </a>
                </div>
                <div className="place-card__info">
                  <div className="place-card__price-wrapper">
              ...
              <article className="near-places__card place-card">
                <div className="near-places__image-wrapper place-card__image-wrapper">
                  <a href="#/">
                    <img className="place-card__image" src="img/apartment-03.jpg" style = {{width:'260', height:'200'}} alt="Place" />
                  </a>
                </div>
                <div className="place-card__info">
                  <div className="place-card__price-wrapper">
...
export default PageOfferProperty;
